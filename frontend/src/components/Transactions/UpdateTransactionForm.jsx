...
import { addTransactionAPI, getTransactionAPI, updateTransactionAPI } from "../../services/transactions/transactionServices";
...
const TransactionForm = () => {
  ...
  const {mutateAsync,isPending,error:transErr,isSuccess}=useMutation({
    mutationFn:updateTransactionAPI,
    mutationKey:['update-transaction']
  })

  const {data:transaction}=useQuery({
    queryFn:()=>getTransactionAPI(params),
    queryKey:['update-transaction'],
  })
